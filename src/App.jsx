...
export default function App() {
  ...
  const sendOtp = async () => {
    ...
    if (!contactInfo.phone || contactInfo.phone.length < 7) {
      setContactErr({ phone: lang==="tr"?"Geçerli telefon girin":"Please enter a valid phone" });
      return;
    }
    setContactErr({});
    setOtpSending(true);
          ...
          <div className="sheet" onClick={e => e.stopPropagation()}>
            ...
            <div className="sh-body">
              {otpStep === "email" ? <>
                <div className="inote">
                  {lang==="tr"
                    ? "Göndermeden önce e-posta adresinizi doğrulamamız gerekiyor. Doğrulama kodu gönderilecek."
                    : "We need to verify your email before publishing. A verification code will be sent."}
                </div>
                <div className="fg">
